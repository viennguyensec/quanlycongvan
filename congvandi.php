    ...
    <div class="col-sm-12 col-lg-12">
      <div class="panel-group">
        <div class="panel panel-default">
          ...
          <div id="collapse" class="panel-collapse collapse panel-body">
            <form action="#" id="form-search-congvandi" name="searchForm" method="post">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <i class="fa fa-wechat"></i> Công văn đi
          <div class="pull-right"> <button class="btn btn-success btn-xs" onclick="window.location='congvandiForm.php';"> <i class="fa fa-plus"></i> Thêm </button> </div>
        </div>
...
<script>
  document.searchForm.submit.addEventListener("click", function(event){
    ...
    $.get("congvandiSearch.php", params).done(function(data){
...
<script>
  ...
  function mulDelete() {
    ...
    if (arrayID.length) {
      $.post("congvandiMulDelete.php", {arrayID: arrayID}).done(function(data){
