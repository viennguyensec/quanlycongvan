...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Cơ quan ban hành</h1>
    </div>
  </div>
    ...
    <div class="col-sm-8 col-lg-8">
      <div class="panel panel-default">
        <div class="panel-heading">
          <i class="fa fa-wechat"></i> Cơ quan ban hành
          <div class="pull-right"> <button class="btn btn-success btn-xs" onclick="window.location='coquanbanhanhForm.php';"> <i class="fa fa-plus"></i> Thêm </button> </div>
        </div>
                      ...
                      echo "<tr>";
                        ...
                        echo "<td class='text-center'>";
                          echo '<span class="btn-group btn-group-xs">';
                            //echo '<a href="timkiem.php?coquanbanhanhId='. $row['id'] .'" class="btn btn-default"><i class="fas fa-eye fa-fw fa-xs"></i></a>';
                            echo '<a href="coquanbanhanhForm.php?id='. $row['id'] .'&action=update" class="btn btn-default edit"><i class="fas fa-pencil-alt fa-fw fa-xs"></i></a>';
                            echo '<a href="coquanbanhanhDelete.php?id=' . $row['id'] . '&action=delete" class="btn btn-danger delete"><i class="fas fa-times fa-fw fa-xs"></i></a>';
                          echo '</span>';
                        echo "</td>";
                      echo "</tr>";
                    }
...
<script>
  ...
  function mulDelete() {
    ...
    if (arrayID.length) {
      $.post("coquanbanhanhMulDelete.php", {arrayID: arrayID}).done(function(data){
